...
{
    public static IServiceCollection AddMediatorModule(this IServiceCollection services, params Assembly[] assemblies)
    {
        ...
        {
            RegisterClosedTypesOf(services, mediatorOpenType, assemblies);
        }
    ...
    private static void RegisterClosedTypesOf(IServiceCollection services, Type openGenericType, Assembly[] assemblies)
    {
