...
internal class CreatePermanentContractOfferCommandValidator : AbstractValidator<CreatePermanentContractOfferCommand>
{
    public CreatePermanentContractOfferCommandValidator()
    {
