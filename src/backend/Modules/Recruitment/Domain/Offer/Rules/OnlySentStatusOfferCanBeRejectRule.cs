...
public class OnlySentStatusOfferCanBeRejectRule : IBusinessRule
{
    private readonly OfferStatus _offerStatus;

    public OnlySentStatusOfferCanBeRejectRule(OfferStatus offerStatus)
    {
    ...
    public string Message => "An offer that has already expired or been accepted/rejected cannot be reject";
}