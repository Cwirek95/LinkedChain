using LinkedChain.Modules.Agreements.Infrastructure.Configuration.Inbox;
using LinkedChain.Modules.Agreements.Infrastructure.Configuration.InternalCommands;
...
internal static class QuartzStartup
{
    ...
    internal static void Initialize(ILogger logger, long? internalProcessingPoolingInterval)
    {
        ...
        {
            { "quartz.scheduler.instanceName", "Agreements" }
        };
